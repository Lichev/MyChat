...
urlpatterns = [
    ...
    path("accept/<int:friendship_request_id>/", friendship_accept, name='friendship_accept'),
    path("reject/<int:friendship_request_id>/", friendship_reject, name='friendship_reject'),
    path("cancel/<int:friendship_request_id>/", friendship_cancel, name='friendship_cancel'),
