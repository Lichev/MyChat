...
from USERS.views import (
    LogoutView, RegisterView, LoginView, EmailVerificationView, ActivateUserView,
...
urlpatterns = [
    ...
    # Shown after submitting the reset email form ("check your inbox")
    ...
    # Shown after the new password has been set ("all done")
    path('reset/done/',
