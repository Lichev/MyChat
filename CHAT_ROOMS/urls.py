...
from CHAT_ROOMS.views import (
    PublicChatRoomView, PublicChatRoomMessages, PublicChatRoomCreateView,
    PublicChatRoomEditView, add_member_to_room, remove_member_from_room,
    search_chat_rooms, chat_rooms_info_json,
)
...
urlpatterns = [
    ...
    path('add_member/<int:room_id>/<str:username>/', add_member_to_room, name='add_member_to_room'),
    path('remove_member/<int:room_id>/<str:username>/', remove_member_from_room, name='remove_member_from_room'),
